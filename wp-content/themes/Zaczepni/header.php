				...
				<ul id="et-social-icons">
					...
					<li class="twitter">
						<a href="<?php echo esc_url( et_get_option( 'nexus_twitter_url', '#' ) ); ?>">
							<span class="et-social-normal"><?php esc_html_e( 'Sprawdź kanał na YouTube', 'Nexus' ); ?></span>
					...
					<li class="facebook">
						<a href="<?php echo esc_url( et_get_option( 'nexus_facebook_url', '#' ) ); ?>">
							<span class="et-social-normal"><?php esc_html_e( 'Zobacz Zaczepnych na Facebooku', 'Nexus' ); ?></span>
							<span class="et-social-hover"></span>
						</a>
					</li>
					<?php endif; ?>
					...
					<li class="rss">
						...
						<a href="<?php echo esc_url( $et_rss_url ); ?>">
							<span class="et-social-normal"><?php esc_html_e( 'Zobacz Zaczepnych Instagramie', 'Nexus' ); ?></span>
							<span class="et-social-hover"></span>
						</a>
					</li>
					<?php endif; ?>
					...
					<li class="google">
						<a href="<?php echo esc_url( et_get_option( 'nexus_google_url', '#' ) ); ?>">
							<span class="et-social-normal"><?php esc_html_e( 'Zobacz Zaczepnych na Google+', 'Nexus' ); ?></span>
							<span class="et-social-hover"></span>
						</a>
					</li>
					<?php endif; ?>
